...
export class AuthResourceService extends BaseService {
  ...
  /**
   * Path part for operation apiAuthVerifyLoginPost
   */
  static readonly ApiAuthVerifyLoginPostPath = '/api/auth/verifyLogin';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiAuthVerifyLoginPost()` instead.
   *
   * This method doesn't expect any request body.
   */
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `apiAuthVerifyLoginPost$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiAuthVerifyLoginPost(params?: {
    ...
    return this.apiAuthVerifyLoginPost$Response(params).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
